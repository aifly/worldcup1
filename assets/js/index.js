...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsTalkIndex = __webpack_require__(19);

	var _componentsTalkIndex2 = _interopRequireDefault(_componentsTalkIndex);

	var _componentsMusicIndex = __webpack_require__(35);
	...
	new _vue2['default']({
		...
		components: {
			...
			Talk: _componentsTalkIndex2['default']
		},
		mounted: function mounted() {
			...
			_componentsLibUtilJs2['default'].getOauthurl(function () {
				_this2.updatePv();
			});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "E:\\project\\worldcup1\\components\\index\\index.vue"
	  if (!module.hot.data) {
		...
		methods: {
							...
							_jquery2['default'].ajax({
								...
								success: function success(data) {
									...
									if (data.getret === 0) {
										...
										_libUtil2['default'].wxConfig('我是第' + s.pv + '位种树者', window.desc, url);
									} else {}
								}
							});
						},
			...
			initPoints: function initPoints() {
				...
				var render = function render() {
					...
					_this3.points.map(function (point, i) {
					...
					_this3.running && animationFrame(render);
				};
	        ...
	        s.team2 = {
				...
				return;
				_jquery2['default'].getJSON("./assets/data/base.json", function (data) {
					if (data.code === 0) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@charset \"UTF-8\";\r\n.lt-full {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0; }\r\n\r\n.zmiti-text-overflow {\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n  word-break: break-all;\r\n  text-overflow: ellipsis;\r\n  -webkit-text-overflow: ellipsis; }\r\n\r\n.zmiti-play {\r\n  width: .8rem;\r\n  height: .8rem;\r\n  border-radius: 50%;\r\n  position: fixed;\r\n  z-index: 1000;\r\n  right: .5rem;\r\n  top: .5rem; }\r\n  .zmiti-play.rotate {\r\n    -webkit-animation: rotate 5s linear infinite;\r\n    animation: rotate 5s linear infinite; }\r\n\r\n@-webkit-keyframes rotate {\r\n  to {\r\n    -webkit-transform: rotate(360deg);\r\n    transform: rotate(360deg); } }\r\n.zmiti-index-main-ui {\r\n  overflow: hidden;\r\n  position: fixed !important;\r\n  width: 750px;\r\n  /* left: 50% !important;\r\n  margin-left: -$viewW / 2; */\r\n  background: #4081dd;\r\n  opacity: 0;\r\n  z-index: -1; }\r\n  .zmiti-index-main-ui.active:after {\r\n    content: '';\r\n    position: absolute;\r\n    width: 100%;\r\n    height: 100%;\r\n    background: rgba(0, 0, 0, 0.5); }\r\n  .zmiti-index-main-ui .zmiti-createimg {\r\n    -webkit-transform: scale(0.75);\r\n    transform: scale(0.75);\r\n    -webkit-transform-origin: center 45%;\r\n    transform-origin: center 45%;\r\n    box-sizing: border-box;\r\n    position: absolute;\r\n    z-index: 102; }\r\n    .zmiti-index-main-ui .zmiti-createimg.zmiti-scale-enter-active, .zmiti-index-main-ui .zmiti-createimg.zmiti-scale-leave-active {\r\n      -webkit-transition: 0.5s;\r\n      transition: 0.5s; }\r\n    .zmiti-index-main-ui .zmiti-createimg.zmiti-scale-enter, .zmiti-index-main-ui .zmiti-createimg.zmiti-scale-leave-to {\r\n      -webkit-transform: scale(1);\r\n      transform: scale(1); }\r\n    .zmiti-index-main-ui .zmiti-createimg:after {\r\n      content: '\\957F\\6309\\4FDD\\5B58\\56FE\\7247';\r\n      position: absolute;\r\n      color: #fff;\r\n      font-size: 30px;\r\n      bottom: 0;\r\n      left: 101%; }\r\n    .zmiti-index-main-ui .zmiti-createimg img {\r\n      border: 10px solid #fff;\r\n      box-sizing: border-box;\r\n      border-radius: 10px; }\r\n    .zmiti-index-main-ui .zmiti-createimg .zmiti-share-btn {\r\n      position: absolute;\r\n      z-index: 10;\r\n      color: #fff;\r\n      background: #aa0707;\r\n      margin-top: 30px;\r\n      left: 50%;\r\n      -webkit-transform: translateX(-50%) scale(1.2);\r\n      transform: translateX(-50%) scale(1.2);\r\n      padding: 14px 40px;\r\n      border-radius: 10px;\r\n      border: 2px solid #fff; }\r\n  .zmiti-index-main-ui.show {\r\n    opacity: 1;\r\n    z-index: 300; }\r\n  .zmiti-index-main-ui .zmiti-index-logo {\r\n    position: absolute;\r\n    right: 0;\r\n    width: 300px;\r\n    top: 0;\r\n    z-index: 1000; }\r\n  .zmiti-index-main-ui canvas {\r\n    position: absolute;\r\n    left: 0;\r\n    top: 0; }\r\n  .zmiti-index-main-ui .zmiti-index {\r\n    display: -webkit-box;\r\n    -webkit-box-align: center;\r\n    -webkit-box-pack: center;\r\n    -webkit-box-orient: vertical; }\r\n    .zmiti-index-main-ui .zmiti-index > div.zmiti-title {\r\n      height: 80vh;\r\n      -webkit-box-flex: 1; }\r\n    .zmiti-index-main-ui .zmiti-index .zmiti-index-bottom {\r\n      height: 200px;\r\n      width: 100%;\r\n      -webkit-box-flex: 0;\r\n      position: relative; }\r\n      .zmiti-index-main-ui .zmiti-index .zmiti-index-bottom .zmiti-copyright {\r\n        position: absolute;\r\n        -webkit-transform: scale(0.9) translate3d(-50%, 0, 0);\r\n        transform: scale(0.9) translate3d(-50%, 0, 0);\r\n        color: #fff;\r\n        font-size: 26px;\r\n        left: 50%;\r\n        bottom: 10px; }\r\n        .zmiti-index-main-ui .zmiti-index .zmiti-index-bottom .zmiti-copyright img {\r\n          width: 260px; }\r\n      .zmiti-index-main-ui .zmiti-index .zmiti-index-bottom .zmiti-index-btns {\r\n        position: absolute;\r\n        width: 70%;\r\n        left: 15%;\r\n        height: 160px;\r\n        bottom: 70px;\r\n        display: -webkit-box;\r\n        -webkit-box-align: center;\r\n        -webkit-box-pack: center;\r\n        -webkit-box-orient: horizontal;\r\n        -webkit-box-pack: justify;\r\n        color: #fff;\r\n        text-align: center; }\r\n        .zmiti-index-main-ui .zmiti-index .zmiti-index-bottom .zmiti-index-btns > div {\r\n          width: 160px;\r\n          height: 60px;\r\n          line-height: 60px;\r\n          background: #770925;\r\n          border-radius: 16px;\r\n          border: 2px solid #fff;\r\n          font-size: 32px; }\r\n          .zmiti-index-main-ui .zmiti-index .zmiti-index-bottom .zmiti-index-btns > div:last-of-type {\r\n            background: #21426e;\r\n            border-color: #ab9956; }\r\n  .zmiti-index-main-ui .zmiti-title {\r\n    position: relative;\r\n    width: 100vw;\r\n    left: 0%;\r\n    top: 0vh;\r\n    z-index: 10;\r\n    display: -webkit-box;\r\n    -webkit-box-align: center;\r\n    -webkit-box-pack: center;\r\n    -webkit-box-orient: vertical;\r\n    -webkit-box-pack: justify; }\r\n    .zmiti-index-main-ui .zmiti-title > img {\r\n      position: relative;\r\n      top: 200px; }\r\n    .zmiti-index-main-ui .zmiti-title .zmiti-vs {\r\n      width: 750px;\r\n      margin: 150px 0 0 0;\r\n      display: -webkit-box;\r\n      -webkit-box-align: center;\r\n      -webkit-box-pack: center;\r\n      -webkit-box-orient: horizontal;\r\n      -webkit-box-pack: justify; }\r\n      .zmiti-index-main-ui .zmiti-title .zmiti-vs > div {\r\n        position: relative;\r\n        -webkit-box-flex: 1; }\r\n        .zmiti-index-main-ui .zmiti-title .zmiti-vs > div:nth-of-type(2) {\r\n          width: 80px;\r\n          text-align: center; }\r\n          .zmiti-index-main-ui .zmiti-title .zmiti-vs > div:nth-of-type(2) img {\r\n            width: 70px; }\r\n        .zmiti-index-main-ui .zmiti-title .zmiti-vs > div:nth-of-type(1) span {\r\n          line-height: 110px;\r\n          width: 65%;\r\n          left: 0;\r\n          right: auto; }\r\n      .zmiti-index-main-ui .zmiti-title .zmiti-vs span {\r\n        position: absolute;\r\n        height: 100%;\r\n        text-align: center;\r\n        top: 0;\r\n        line-height: 130px;\r\n        width: 70%;\r\n        right: 0;\r\n        font-size: 32px;\r\n        color: #fff; }\r\n    .zmiti-index-main-ui .zmiti-title .zmiti-perosn {\r\n      width: 750px;\r\n      position: relative;\r\n      display: -webkit-box;\r\n      -webkit-box-align: center;\r\n      -webkit-box-pack: center;\r\n      -webkit-box-orient: horizontal; }\r\n      .zmiti-index-main-ui .zmiti-title .zmiti-perosn > div > img {\r\n        margin-top: 100px; }\r\n      .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score {\r\n        width: 400px;\r\n        height: 300px;\r\n        white-space: normal; }\r\n        .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C {\r\n          display: -webkit-box;\r\n          -webkit-box-align: center;\r\n          -webkit-box-pack: center;\r\n          -webkit-box-orient: horizontal;\r\n          border-radius: 15px;\r\n          background: #78a1b9;\r\n          height: 140px;\r\n          left: 80px;\r\n          position: absolute;\r\n          width: 78%;\r\n          bottom: 40px;\r\n          margin: 0 auto; }\r\n          .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div {\r\n            height: 100%;\r\n            display: -webkit-box;\r\n            -webkit-box-align: center;\r\n            -webkit-box-pack: center;\r\n            -webkit-box-orient: horizontal;\r\n            position: relative; }\r\n            .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div > div {\r\n              position: relative; }\r\n            .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div span {\r\n              position: absolute;\r\n              width: 100%;\r\n              height: 100%;\r\n              text-align: center;\r\n              line-height: 150px;\r\n              color: #ffe400;\r\n              font-size: 50px;\r\n              left: 0;\r\n              top: 0;\r\n              z-index: 12; }\r\n            .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div img {\r\n              position: relative;\r\n              width: 100px;\r\n              height: auto;\r\n              display: block; }\r\n            .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(1), .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(3) {\r\n              overflow: hidden;\r\n              -webkit-box-flex: 1; }\r\n              .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(1) label, .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(3) label {\r\n                position: absolute;\r\n                left: 0;\r\n                bottom: 0;\r\n                z-index: 10;\r\n                width: 33.333%;\r\n                height: 6px; }\r\n                .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(1) label:nth-of-type(1), .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(3) label:nth-of-type(1) {\r\n                  background: #001d99; }\r\n                .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(1) label:nth-of-type(2), .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(3) label:nth-of-type(2) {\r\n                  background: #fcfcfc;\r\n                  left: 33.3%; }\r\n                .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(1) label:nth-of-type(3), .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(3) label:nth-of-type(3) {\r\n                  background: #f02432;\r\n                  left: 66.67%; }\r\n            .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(2) {\r\n              width: 50px; }\r\n              .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(2):before {\r\n                content: \"\";\r\n                width: 40px;\r\n                height: 6px;\r\n                background: #fff;\r\n                position: absolute;\r\n                z-index: 10;\r\n                top: 50%;\r\n                margin-top: -3px; }\r\n            .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(3) label:nth-of-type(1) {\r\n              background: #000000; }\r\n            .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score .zmiti-score-C > div:nth-of-type(3) label:nth-of-type(2) {\r\n              background: #fbe32a;\r\n              left: 33.3%; }\r\n        .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score section {\r\n          position: absolute;\r\n          top: 0px;\r\n          z-index: 10;\r\n          word-wrap: break-word;\r\n          width: 450px;\r\n          height: 100%; }\r\n          .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score section img {\r\n            position: absolute;\r\n            width: 100%;\r\n            height: 100%;\r\n            z-index: 10; }\r\n          .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score section > div {\r\n            color: #777;\r\n            width: 75%;\r\n            margin-left: 20%; }\r\n            .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score section > div:nth-of-type(1) {\r\n              margin-top: 10px;\r\n              color: #fff;\r\n              font-size: 32px; }\r\n            .zmiti-index-main-ui .zmiti-title .zmiti-perosn .zmiti-score section > div:nth-of-type(2) {\r\n              text-align: right; }\r\n  .zmiti-index-main-ui .zmiti-result {\r\n    background: rgba(0, 0, 0, 0.5);\r\n    z-index: 100; }\r\n\r\n.zmiti-loading {\r\n  z-index: 1000; }\r\n  .zmiti-loading .zmiti-loading-ui {\r\n    width: 6rem;\r\n    left: 2rem;\r\n    position: absolute;\r\n    top: 6rem; }\r\n    .zmiti-loading .zmiti-loading-ui .zmiti-loading-bar {\r\n      width: 2rem;\r\n      border-radius: 10px;\r\n      position: relative;\r\n      margin: 0 auto; }\r\n      .zmiti-loading .zmiti-loading-ui .zmiti-loading-bar:before {\r\n        content: '';\r\n        border-radius: 10px;\r\n        position: absolute;\r\n        left: 0;\r\n        top: 0;\r\n        width: 100%;\r\n        height: 100%;\r\n        box-shadow: 0 0 3px rgba(255, 255, 255, 0.5); }\r\n      .zmiti-loading .zmiti-loading-ui .zmiti-loading-bar .zmiti-target {\r\n        width: 0.4rem;\r\n        height: 0.4rem;\r\n        border-radius: 50%;\r\n        background: #fff;\r\n        left: 50%;\r\n        top: .4rem;\r\n        position: absolute;\r\n        margin-left: -0.2rem;\r\n        -webkit-animation: scale linear 2s infinite alternate;\r\n        animation: scale linear 2s infinite alternate; }\r\n    .zmiti-loading .zmiti-loading-ui .zmiti-progress {\r\n      margin-top: .5rem;\r\n      text-align: center;\r\n      color: #fff;\r\n      font-family: Georgia;\r\n      font-size: .7rem; }\r\n\r\n/*# sourceMappingURL=index.css.map */\r\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var zmitiUtil = {
		...
		getOauthurl: function getOauthurl(fn) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\worldcup1\\components\\talk\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports['default'] = {
		...
		methods: {
			...
			send: function send() {
				...
				this.headimgurl = window.headimgurl || _libAssetsJs.imgs.logo;
				this.nickname = window.nickname || '新华社网友';

				s.talkList.splice(s.index + 1, 0, {
					"headimgurl": window.headimgurl || _libAssetsJs.imgs.logo,
				...
				setTimeout(function () {
					...
					setTimeout(function () {
						if (_this.viewH - 100 - 350 - _this.$refs['ul'].offsetHeight <= 0) {
							_this.scroll.scrollTo(0, _this.viewH - 100 - 350 - _this.$refs['ul'].offsetHeight, 100);
						}
	   	...
	   	success(data){
			...
			getBarrage: function getBarrage() {
				//获取弹幕
				var s = this;
				/*$.ajax({
	   	...
	   	return;*/
				_jquery2['default'].getJSON("./assets/data/barrage.json", function (data) {
					if (data.code === 0) {
			...
			html2img: function html2img() {
				...
				var ref = arguments.length <= 0 || arguments[0] === undefined ? 'page1' : arguments[0];
					...
					success: function success(data) {
						try {
							...
							if (data.code === 0) {
								...
								s.loading(arr, function (e) {
									//console.log(e)
								});
								s.talkList.push({
									"headimgurl": _libAssetsJs.imgs.cow,
									"nickname": '小牛',
									"text": '我同意小新的观点',
									"image": '',
									"className": "",
		...
		mounted: function mounted() {
			...
			obserable.on('entryTalk', function (data) {
				...
				_this3.show = true;
				_this3.team1 = data.team1;
				_this3.team2 = data.team2;
				_this3.points = data.points;
				var iNow = 0;

				setTimeout(function () {
					_this3.showHand = false;
				}, 2000);
				...
				_this3.timer = setInterval(function () {
					...
					if (_this3.countdown <= 0) {
						var result1 = 0,
						    result2 = 0;
						_this3.talkList.forEach(function (item, i) {
							if (item.isreverse) {
								result1++;
							} else {
								result2++;
						...
						if (result1 > result2) {
							_this3.result = _libAssetsJs.imgs.result1;
						} else {
							_this3.result = _libAssetsJs.imgs.result2;
						}
						///this.html2img('page2');
						setTimeout(function () {
							_this3.closeResult();
					...
					if (iNow % 2 === 0) {
						_this3.index++;
						if (_this3.index <= _this3.talkList.length - 1) {
							setTimeout(function () {
						...
						if (_this3.index >= _this3.talkList.length - 1) {
							_this3.index = _this3.talkList.length - 1;
						}
					}
				}, 1000);
			});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@charset \"UTF-8\";\r\n.lt-full {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0; }\r\n\r\n.zmiti-text-overflow {\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n  word-break: break-all;\r\n  text-overflow: ellipsis;\r\n  -webkit-text-overflow: ellipsis; }\r\n\r\n.zmiti-play {\r\n  width: .8rem;\r\n  height: .8rem;\r\n  border-radius: 50%;\r\n  position: fixed;\r\n  z-index: 1000;\r\n  right: .5rem;\r\n  top: .5rem; }\r\n  .zmiti-play.rotate {\r\n    -webkit-animation: rotate 5s linear infinite;\r\n    animation: rotate 5s linear infinite; }\r\n\r\n@-webkit-keyframes rotate {\r\n  to {\r\n    -webkit-transform: rotate(360deg);\r\n    transform: rotate(360deg); } }\r\n.zmiti-talk-main-ui {\r\n  opacity: 0;\r\n  z-index: -1;\r\n  position: fixed !important;\r\n  background: #fdf7eb;\r\n  display: -webkit-box;\r\n  -webkit-box-align: center;\r\n  -webkit-box-pack: center;\r\n  -webkit-box-orient: vertical; }\r\n  .zmiti-talk-main-ui .zmiti-createimg {\r\n    -webkit-transform: scale(0.75);\r\n    transform: scale(0.75);\r\n    -webkit-transform-origin: center 45%;\r\n    transform-origin: center 45%;\r\n    box-sizing: border-box;\r\n    position: absolute;\r\n    z-index: 102; }\r\n    .zmiti-talk-main-ui .zmiti-createimg.zmiti-scale-enter-active, .zmiti-talk-main-ui .zmiti-createimg.zmiti-scale-leave-active {\r\n      -webkit-transition: 0.5s;\r\n      transition: 0.5s; }\r\n    .zmiti-talk-main-ui .zmiti-createimg.zmiti-scale-enter, .zmiti-talk-main-ui .zmiti-createimg.zmiti-scale-leave-to {\r\n      -webkit-transform: scale(1);\r\n      transform: scale(1); }\r\n    .zmiti-talk-main-ui .zmiti-createimg:after {\r\n      content: '\\957F\\6309\\4FDD\\5B58\\56FE\\7247';\r\n      position: absolute;\r\n      color: #fff;\r\n      font-size: 30px;\r\n      bottom: 0;\r\n      left: 101%; }\r\n    .zmiti-talk-main-ui .zmiti-createimg img {\r\n      border: 10px solid #fff;\r\n      box-sizing: border-box;\r\n      border-radius: 10px; }\r\n    .zmiti-talk-main-ui .zmiti-createimg .zmiti-share-btn {\r\n      position: absolute;\r\n      z-index: 10;\r\n      color: #fff;\r\n      background: #aa0707;\r\n      margin-top: 30px;\r\n      left: 50%;\r\n      -webkit-transform: translateX(-50%) scale(1.2);\r\n      transform: translateX(-50%) scale(1.2);\r\n      padding: 14px 40px;\r\n      border-radius: 10px;\r\n      border: 2px solid #fff; }\r\n  .zmiti-talk-main-ui .zmiti-result-page {\r\n    z-index: 199000; }\r\n    .zmiti-talk-main-ui .zmiti-result-page .zmiti-result-content {\r\n      width: 600px;\r\n      height: 500px;\r\n      position: absolute;\r\n      left: 50%;\r\n      top: 50%;\r\n      -webkit-transform: translate(-50%, -50%);\r\n      transform: translate(-50%, -50%); }\r\n      .zmiti-talk-main-ui .zmiti-result-page .zmiti-result-content .zmiti-result-user {\r\n        display: -webkit-box;\r\n        -webkit-box-align: center;\r\n        -webkit-box-pack: center;\r\n        -webkit-box-orient: horizontal;\r\n        color: #fffd58; }\r\n        .zmiti-talk-main-ui .zmiti-result-page .zmiti-result-content .zmiti-result-user div {\r\n          margin: 10px; }\r\n        .zmiti-talk-main-ui .zmiti-result-page .zmiti-result-content .zmiti-result-user > div:nth-of-type(1) {\r\n          text-align: center; }\r\n          .zmiti-talk-main-ui .zmiti-result-page .zmiti-result-content .zmiti-result-user > div:nth-of-type(1) img {\r\n            display: block;\r\n            margin: 0 auto 10px;\r\n            border-radius: 100px; }\r\n        .zmiti-talk-main-ui .zmiti-result-page .zmiti-result-content .zmiti-result-user > div:nth-of-type(2) > div:nth-of-type(1) {\r\n          font-size: 70px;\r\n          font-weight: bold; }\r\n        .zmiti-talk-main-ui .zmiti-result-page .zmiti-result-content .zmiti-result-user > div:nth-of-type(2) > div:nth-of-type(2) {\r\n          color: #fafa8f; }\r\n    .zmiti-talk-main-ui .zmiti-result-page h1 {\r\n      line-height: 120px;\r\n      padding-left: 50px;\r\n      font-size: 22px;\r\n      color: #fff;\r\n      font-weight: normal; }\r\n      .zmiti-talk-main-ui .zmiti-result-page h1 img {\r\n        width: 250px; }\r\n    .zmiti-talk-main-ui .zmiti-result-page .zmiti-zheng {\r\n      position: absolute;\r\n      z-index: 10;\r\n      right: 10px;\r\n      bottom: 10px; }\r\n    .zmiti-talk-main-ui .zmiti-result-page .zmiti-qrcode {\r\n      position: absolute;\r\n      z-index: 10;\r\n      bottom: 20px;\r\n      left: 20px;\r\n      width: 200px; }\r\n  .zmiti-talk-main-ui .zmiti-talk-form {\r\n    height: 100px;\r\n    width: 100%;\r\n    background: #fff;\r\n    text-align: center; }\r\n    .zmiti-talk-main-ui .zmiti-talk-form > div {\r\n      width: 90%;\r\n      margin: 0 auto;\r\n      line-height: 100px; }\r\n    .zmiti-talk-main-ui .zmiti-talk-form input {\r\n      width: 80%;\r\n      border: 1px solid #cccccc;\r\n      height: 60px;\r\n      vertical-align: middle;\r\n      font-size: 32px;\r\n      outline: none; }\r\n    .zmiti-talk-main-ui .zmiti-talk-form span {\r\n      border: 1px solid  #ccc;\r\n      padding: 8px 16px;\r\n      vertical-align: middle;\r\n      position: relative;\r\n      top: 2px;\r\n      border-radius: 10px;\r\n      color: #ccc; }\r\n      .zmiti-talk-main-ui .zmiti-talk-form span.active {\r\n        background: #20ab2c;\r\n        color: #fff; }\r\n  .zmiti-talk-main-ui > section {\r\n    -webkit-box-flex: 1; }\r\n    .zmiti-talk-main-ui > section .zmiti-talk-content {\r\n      position: relative;\r\n      overflow: hidden; }\r\n      .zmiti-talk-main-ui > section .zmiti-talk-content li {\r\n        width: 90%;\r\n        margin: 15px auto;\r\n        display: -webkit-box;\r\n        -webkit-box-align: center;\r\n        -webkit-box-pack: center;\r\n        -webkit-box-orient: horizontal;\r\n        -webkit-box-pack: start; }\r\n        .zmiti-talk-main-ui > section .zmiti-talk-content li.right {\r\n          -webkit-box-pack: end;\r\n          -webkit-box-direction: reverse; }\r\n          .zmiti-talk-main-ui > section .zmiti-talk-content li.right > div .zmiti-headimg {\r\n            margin: 0 auto; }\r\n          .zmiti-talk-main-ui > section .zmiti-talk-content li.right > div:nth-of-type(1) {\r\n            width: 92px;\r\n            height: 92px;\r\n            border-radius: 50%; }\r\n          .zmiti-talk-main-ui > section .zmiti-talk-content li.right > div:nth-of-type(2) > div {\r\n            background: #a1e75b;\r\n            padding: 20px 20px;\r\n            border-radius: 10px;\r\n            position: relative;\r\n            max-width: 300px;\r\n            margin-right: 30px;\r\n            top: -10px; }\r\n            .zmiti-talk-main-ui > section .zmiti-talk-content li.right > div:nth-of-type(2) > div:before {\r\n              background: #a1e75b;\r\n              right: -10px;\r\n              left: auto; }\r\n        .zmiti-talk-main-ui > section .zmiti-talk-content li > div:nth-of-type(1) {\r\n          text-align: center;\r\n          color: #fff;\r\n          font-size: 28px; }\r\n        .zmiti-talk-main-ui > section .zmiti-talk-content li > div span {\r\n          display: inline-block;\r\n          white-space: normal;\r\n          word-wrap: break-word; }\r\n        .zmiti-talk-main-ui > section .zmiti-talk-content li > div:nth-of-type(2) {\r\n          margin-left: 40px; }\r\n          .zmiti-talk-main-ui > section .zmiti-talk-content li > div:nth-of-type(2) .zmiti-talk-img {\r\n            background: #fff;\r\n            padding: 10px;\r\n            max-width: 400px;\r\n            box-sizing: border-box; }\r\n            .zmiti-talk-main-ui > section .zmiti-talk-content li > div:nth-of-type(2) .zmiti-talk-img img {\r\n              z-index: 10;\r\n              position: relative; }\r\n          .zmiti-talk-main-ui > section .zmiti-talk-content li > div:nth-of-type(2) > div {\r\n            background: #fff;\r\n            padding: 20px 20px;\r\n            border-radius: 10px;\r\n            position: relative; }\r\n            .zmiti-talk-main-ui > section .zmiti-talk-content li > div:nth-of-type(2) > div:before {\r\n              content: '';\r\n              position: absolute;\r\n              width: 26px;\r\n              height: 26px;\r\n              background: #fff;\r\n              -webkit-transform: rotate(45deg);\r\n              transform: rotate(45deg);\r\n              left: -10px;\r\n              top: 50%;\r\n              margin-top: -20px; }\r\n        .zmiti-talk-main-ui > section .zmiti-talk-content li .zmiti-headimg {\r\n          width: 80px;\r\n          display: block;\r\n          border-radius: 50%;\r\n          border: 6px solid #fff; }\r\n    .zmiti-talk-main-ui > section .zmiti-talk-title {\r\n      position: relative;\r\n      z-index: 10; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage {\r\n      position: absolute;\r\n      left: 100%;\r\n      top: 0;\r\n      color: #fff;\r\n      -webkit-animation: move 4s linear infinite;\r\n      width: 100%; }\r\n      .zmiti-talk-main-ui > section .zmiti-barrage img {\r\n        width: 40px;\r\n        border-radius: 50%; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(1) {\r\n      -webkit-animation: move 40s 2s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(2) {\r\n      -webkit-animation: move 40s 4s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(3) {\r\n      -webkit-animation: move 8s 6s linear infinite;\r\n      top: 40px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(4) {\r\n      -webkit-animation: move 40s 8s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(5) {\r\n      -webkit-animation: move 8s 10s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(6) {\r\n      -webkit-animation: move 8s 12s linear infinite;\r\n      top: 40px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(7) {\r\n      -webkit-animation: move 32s 14s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(8) {\r\n      -webkit-animation: move 32s 16s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(9) {\r\n      -webkit-animation: move 8s 18s linear infinite;\r\n      top: 40px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(10) {\r\n      -webkit-animation: move 40s 20s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(11) {\r\n      -webkit-animation: move 8s 22s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(12) {\r\n      -webkit-animation: move 16s 24s linear infinite;\r\n      top: 40px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(13) {\r\n      -webkit-animation: move 40s 26s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(14) {\r\n      -webkit-animation: move 24s 28s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(15) {\r\n      -webkit-animation: move 24s 30s linear infinite;\r\n      top: 40px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(16) {\r\n      -webkit-animation: move 40s 32s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(17) {\r\n      -webkit-animation: move 16s 34s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(18) {\r\n      -webkit-animation: move 24s 36s linear infinite;\r\n      top: 40px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(19) {\r\n      -webkit-animation: move 8s 38s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(20) {\r\n      -webkit-animation: move 16s 40s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(21) {\r\n      -webkit-animation: move 16s 42s linear infinite;\r\n      top: 40px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(22) {\r\n      -webkit-animation: move 32s 44s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(23) {\r\n      -webkit-animation: move 32s 46s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(24) {\r\n      -webkit-animation: move 8s 48s linear infinite;\r\n      top: 40px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(25) {\r\n      -webkit-animation: move 24s 50s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(26) {\r\n      -webkit-animation: move 8s 52s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(27) {\r\n      -webkit-animation: move 32s 54s linear infinite;\r\n      top: 40px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(28) {\r\n      -webkit-animation: move 16s 56s linear infinite;\r\n      top: 80px; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(29) {\r\n      -webkit-animation: move 16s 58s linear infinite; }\r\n    .zmiti-talk-main-ui > section .zmiti-barrage:nth-of-type(30) {\r\n      -webkit-animation: move 16s 60s linear infinite;\r\n      top: 40px; }\r\n@-webkit-keyframes move {\r\n  to {\r\n    -webkit-transform: translate3d(-1250px, 0, 0); } }\r\n    .zmiti-talk-main-ui > section .zmiti-talk-pk-C {\r\n      position: absolute;\r\n      top: 120px;\r\n      width: 100%; }\r\n    .zmiti-pk {\r\n      display: -webkit-box;\r\n      -webkit-box-align: center;\r\n      -webkit-box-pack: center;\r\n      -webkit-box-orient: horizontal;\r\n      -webkit-box-pack: justify; }\r\n      .zmiti-pk:nth-of-type(1) > div {\r\n        position: relative; }\r\n        .zmiti-pk:nth-of-type(1) > div:nth-of-type(3) span {\r\n          left: 28%; }\r\n      .zmiti-pk:nth-of-type(1) span {\r\n        position: absolute;\r\n        width: 72%;\r\n        top: 30px;\r\n        height: 50px;\r\n        line-height: 50px;\r\n        color: #fff;\r\n        text-align: center; }\r\n      .zmiti-pk:nth-of-type(2) {\r\n        width: 96%;\r\n        margin: 10px auto; }\r\n        .zmiti-pk:nth-of-type(2) > div {\r\n          position: relative; }\r\n          .zmiti-pk:nth-of-type(2) > div img {\r\n            width: 60px;\r\n            position: relative;\r\n            z-index: 10; }\r\n          .zmiti-pk:nth-of-type(2) > div:nth-of-type(1) {\r\n            -webkit-box-flex: 1;\r\n            text-align: right; }\r\n            .zmiti-pk:nth-of-type(2) > div:nth-of-type(1) span {\r\n              background-image: -webkit-linear-gradient(top, #db595d, #a1060a); }\r\n          .zmiti-pk:nth-of-type(2) > div:nth-of-type(2) {\r\n            width: 120px;\r\n            margin: 0 10px; }\r\n            .zmiti-pk:nth-of-type(2) > div:nth-of-type(2) img {\r\n              width: 100%; }\r\n          .zmiti-pk:nth-of-type(2) > div:nth-of-type(3) {\r\n            -webkit-box-flex: 1; }\r\n            .zmiti-pk:nth-of-type(2) > div:nth-of-type(3) span {\r\n              background-image: -webkit-linear-gradient(top, #4a6995, #1c3b67); }\r\n        .zmiti-pk:nth-of-type(2) span {\r\n          position: absolute;\r\n          left: 0;\r\n          top: 50%;\r\n          margin-top: -10px;\r\n          width: 98%;\r\n          height: 20px;\r\n          background: #fff;\r\n          border-radius: 10px;\r\n          border: 2px solid #e2c352; }\r\n    .zmiti-talk-score {\r\n      position: relative;\r\n      /* text-align: center;\r\n      color: #fff;\r\n      font-size: 50px;\r\n      letter-spacing: 20px;\r\n      font-weight: bold;\r\n      margin-top: -20px; */ }\r\n      .zmiti-talk-score .zmiti-hand, .zmiti-talk-score .zmiti-hand1 {\r\n        position: absolute;\r\n        left: 58%;\r\n        top: 60px;\r\n        z-index: 101; }\r\n        .zmiti-talk-score .zmiti-hand img, .zmiti-talk-score .zmiti-hand1 img {\r\n          width: 70px; }\r\n        .zmiti-talk-score .zmiti-hand span, .zmiti-talk-score .zmiti-hand1 span {\r\n          -webkit-transform: translate3d(-26%, -45%, 0);\r\n          transform: translate3d(-26%, -45%, 0);\r\n          -webkit-animation: scale 1s infinite;\r\n          animation: scale 1s infinite;\r\n          position: absolute;\r\n          width: 1rem;\r\n          height: 1rem;\r\n          border-radius: 50%;\r\n          opacity: .5;\r\n          background: rgba(238, 101, 19, 0.5);\r\n          background: #fff;\r\n          left: 0;\r\n          top: 0; }\r\n      .zmiti-talk-score .zmiti-hand1 {\r\n        left: 38%; }\r\n        .zmiti-talk-score .zmiti-hand1 span {\r\n          -webkit-animation: scale 1s 0.5s infinite;\r\n          animation: scale 1s 0.5s infinite; }\r\n@-webkit-keyframes scale {\r\n  from {\r\n    -webkit-transform: translate3d(-26%, -45%, 0) scale(0);\r\n    transform: translate3d(-26%, -45%, 0) scale(0);\r\n    opacity: 1; }\r\n  to {\r\n    -webkit-transform: translate3d(-26%, -45%, 0) scale(1.4);\r\n    transform: translate3d(-26%, -45%, 0) scale(1.4);\r\n    opacity: 0; } }\r\n      .zmiti-talk-score > div {\r\n        display: -webkit-box;\r\n        -webkit-box-align: center;\r\n        -webkit-box-pack: center;\r\n        -webkit-box-orient: horizontal;\r\n        background: #3e7d9d;\r\n        border-radius: 20px;\r\n        border: 6px solid #95ccf3;\r\n        box-sizing: border-box;\r\n        width: 360px;\r\n        height: 150px;\r\n        margin: 10px auto;\r\n        text-align: center;\r\n        color: #ffe400;\r\n        font-size: 24px; }\r\n        .zmiti-talk-score > div img {\r\n          position: absolute !important; }\r\n        .zmiti-talk-score > div .zmiti-talk-score-item {\r\n          font-size: 50px;\r\n          position: relative;\r\n          width: 100px;\r\n          height: 100px;\r\n          display: block;\r\n          left: 0;\r\n          top: 0;\r\n          line-height: 120px; }\r\n          .zmiti-talk-score > div .zmiti-talk-score-item:before {\r\n            content: \"\";\r\n            position: absolute;\r\n            width: 80%;\r\n            left: 10%;\r\n            z-index: 10;\r\n            height: 3px;\r\n            background: #fefefe;\r\n            top: 90px; }\r\n          .zmiti-talk-score > div .zmiti-talk-score-item input[type=number] {\r\n            border: none;\r\n            -webkit-appearance: none;\r\n            font-size: 50px;\r\n            color: #ffe400;\r\n            z-index: 100;\r\n            text-align: center;\r\n            position: absolute;\r\n            display: block;\r\n            width: 30px;\r\n            left: 50%;\r\n            top: 50%;\r\n            -webkit-transform: translate3d(-50%, -50%, 0);\r\n            transform: translate3d(-50%, -50%, 0);\r\n            background: transparent; }\r\n@-webkit-keyframes flash {\r\n  to {\r\n    border-width: 0; } }\r\n        .zmiti-talk-score > div > div {\r\n          position: relative; }\r\n          .zmiti-talk-score > div > div:nth-of-type(1) img, .zmiti-talk-score > div > div:nth-of-type(3) img {\r\n            width: 100px;\r\n            height: auto;\r\n            position: relative;\r\n            display: block; }\r\n          .zmiti-talk-score > div > div:nth-of-type(2) {\r\n            width: 50px;\r\n            height: 100%; }\r\n            .zmiti-talk-score > div > div:nth-of-type(2):before {\r\n              content: \"\";\r\n              width: 30px;\r\n              height: 6px;\r\n              left: 50%;\r\n              -webkit-transform: translate(-50%, 0);\r\n              transform: translate(-50%, 0);\r\n              background: #fff;\r\n              position: absolute;\r\n              z-index: 10;\r\n              top: 50%;\r\n              margin-top: -3px; }\r\n    .zmiti-talk-main-ui > section .zmiti-countdown {\r\n      width: 200px;\r\n      margin: 20px auto;\r\n      position: relative; }\r\n      .zmiti-talk-main-ui > section .zmiti-countdown span {\r\n        position: absolute;\r\n        color: #ffa105;\r\n        font-size: 36px;\r\n        width: 100%;\r\n        text-align: center;\r\n        top: 20px; }\r\n  .zmiti-talk-main-ui.show {\r\n    z-index: 1230;\r\n    opacity: 1; }\r\n  .zmiti-talk-main-ui .zmiti-result {\r\n    z-index: 10;\r\n    background: rgba(0, 0, 0, 0.5);\r\n    display: -webkit-box;\r\n    -webkit-box-align: center;\r\n    -webkit-box-pack: center;\r\n    -webkit-box-orient: horizontal; }\r\n  .zmiti-talk-main-ui .zmiti-tel {\r\n    z-index: 10;\r\n    background: rgba(0, 0, 0, 0.5);\r\n    display: -webkit-box;\r\n    -webkit-box-align: center;\r\n    -webkit-box-pack: center;\r\n    -webkit-box-orient: horizontal; }\r\n    .zmiti-talk-main-ui .zmiti-tel > div {\r\n      position: relative;\r\n      width: 600px; }\r\n      .zmiti-talk-main-ui .zmiti-tel > div input {\r\n        width: 420px;\r\n        height: 60px;\r\n        position: absolute;\r\n        margin-top: -130px;\r\n        left: 50%;\r\n        margin-left: -220px;\r\n        outline: none;\r\n        -webkit-appearance: none;\r\n        border: 1px solid #ccc;\r\n        font-size: 28px;\r\n        padding-left: 10px;\r\n        background: #f0f0f0; }\r\n      .zmiti-talk-main-ui .zmiti-tel > div span {\r\n        position: absolute;\r\n        width: 55px;\r\n        height: 55px;\r\n        right: 0;\r\n        top: 0; }\r\n      .zmiti-talk-main-ui .zmiti-tel > div div {\r\n        margin: 50px auto;\r\n        background: #21426e;\r\n        border: 2px solid #f2e4b0;\r\n        width: 130px;\r\n        height: 50px;\r\n        line-height: 50px;\r\n        text-align: center;\r\n        color: #fff;\r\n        border-radius: 10px; }\r\n\r\n/*# sourceMappingURL=index.css.map */\r\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\worldcup1\\components\\toast\\toast.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7eb4330f&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7eb4330f&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\worldcup1\\components\\music\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
